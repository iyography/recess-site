...
const familyMembers: FamilyMember[] = [
  ...
  { name: "Eric Bryan Gonzales", superpower: "Seeing beyond the obvious - the potential and opportunity in people and business along with the path to get there", needsHelp: "Starting networking and live calls", image: "/profiles/eric.jpeg" },
